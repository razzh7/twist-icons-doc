...
function IconApi() {
  ...
  const data = [
    ...
    },
    {
      ...
      type: 'string',
      default: '-',
      description: t('api.title.description')
    },
    {
      key: '7',
      props: 'spin',
      type: 'boolean',
      default: 'false',
      description: t('api.spin.description')
    },
    {
      key: '8',
      props: 'rotate',
      type: 'string',
      default: '-',
      description: t('api.rotate.description')
    }
  ]

  return <Table columns={columns} data={data} pagination={false} stripe={true} borderCell={true}/>
}
